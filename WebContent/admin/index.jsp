...
<html lang="en">
	...
	<head>
		<meta charset="UTF-8">
		<title>后台管理-明日头条后台管理系统-WeAdmin 1.0</title>
	...
	<body>
		...
		<div class="container">
			<div class="logo">
				<a href="<%=request.getContextPath() %>/admin/index">WeAdmin v1.0</a>
			</div>
			<div class="left_open">
			...
			<ul class="layui-nav right" lay-filter="">
				<li class="layui-nav-item">
					<a href="javascript:;" style="display:flex"><img style="width: 45px; height:45px; margin-right:8px" src="<%=request.getContextPath()%>/userimg/${user.getUserimg() }"> ${user.getUsername()}</a>
					<dl class="layui-nav-child">
						<!-- 二级菜单 -->
						<dd>
							<a onclick="WeAdminShow('个人信息','<%=request.getContextPath()%>/admin/edit')">个人信息</a>
						</dd>
						<dd>
							<a href="<%=request.getContextPath()%>/admin/login">切换帐号</a>
						</dd>
						<dd>
							<a class="loginout" href="<%=request.getContextPath()%>/admin/login">退出</a>
						</dd>
					</dl>
				</li>
				<li class="layui-nav-item to-index">
					<a href="<%=request.getContextPath() %>/admin/index">前台首页</a>
				</li>
			</ul>
			...
			<div id="side-nav">
				<ul id="nav">
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a _href="<%=request.getContextPath() %>/admin/memberlist">
									<i class="iconfont">&#xe6a7;</i>
									<cite>会员列表</cite>
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a _href="<%=request.getContextPath() %>/admin/articlelist">
									<i class="iconfont">&#xe6a7;</i>
									<cite>文章列表</cite>
								</a>
							</li>
					...
					<li>
						...
						<ul class="sub-menu">
							...
							<li>
								<a _href="<%=request.getContextPath() %>/admin/echarts/pie">
									<i class="iconfont">&#xe6a7;</i>
									<cite>饼图</cite>
								</a>
							</li>
