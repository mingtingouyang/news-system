...
<html>
  ...
  <body>
    <div class="weadmin-body">
        <form class="layui-form" action="<%=request.getContextPath() %>/admin/edit" method="POST" enctype="multipart/form-data">
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  	登录名
              </label>
              <input type="text" hidden="hidden" name="username" value="<%=((User)request.getAttribute("user")).getUsername() %>">
              <div class="layui-input-inline">
                  <input disabled="disabled" type="text" id="username" name="user" required="" lay-verify="required"
                  autocomplete="off" value="<%=((User)request.getAttribute("user")).getUsername() %>" class="layui-input" style="background-color:#ccc">
              </div>
          ...
          <div class="layui-form-item">
          		<p><img style="width:100px;height:100px;margin:10px 150px" src="<%=request.getContextPath()%>/userimg/<%=((User)request.getAttribute("user")).getUserimg() %>"></p>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="<%=((User)request.getAttribute("user")).getPhone() %>" id="phone" name="phone" required="" lay-verify="phone"
          ...
          <div class="layui-form-item">
              ...
              <%if(((User)request.getAttribute("user")).getGender().equals("male")) {%>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="<%=((User)request.getAttribute("user")).getPassword() %>">
              </div>
              <div class="layui-form-mid layui-word-aux">
