...
<html>
	<head>
		<meta charset="UTF-8">
		<title>会员列表-明日头条后台管理系统-WeAdmin 1.0</title>
	...
	<body>
        ...
        <a>
          <cite>会员列表</cite></a>
			...
			<a class="layui-btn layui-btn-sm" style="line-height:1.6em;margin-top:3px;float:right" href="<%=request.getContextPath() %>/admin/memberlist" title="刷新">
				<i class="layui-icon" style="line-height:30px">ဂ</i></a>
		</div>
		<div class="weadmin-body">
			<div class="layui-row">
				<form class="layui-form layui-col-md12 we-search" method="POST" action="<%=request.getContextPath() %>/admin/memberlist">
				<!-- 
			...
			<div class="weadmin-block">
				<button class="layui-btn" onclick="WeAdminShow('添加用户','<%=request.getContextPath() %>/admin/member/signup')"><i class="layui-icon"></i>添加</button>
				<span class="fr" style="line-height:40px">共有数据：${totalMembers} 条</span>
			</div>
			<table class="layui-table">
				...
				<tbody>
					...
					<tr>
						...
						<td class="username"><%=members.get(i).getUsername() %></td>
						...
						<td class="td-manage">
							...
							<%} %>
							<a title="编辑" onclick="WeAdminShow('编辑','<%=request.getContextPath()%>/admin/member/edit?edit=<%=members.get(i).getUsername() %>')" href="javascript:;">
								<i class="layui-icon">&#xe642;</i>
							</a>
			...
			<div class="page">
				...
				<%if((Integer)(request.getAttribute("page")) != 1) {%>
					<a class="prev" href="<%=request.getContextPath() %>/admin/memberlist?page=${page - 1}">&lt;&lt;</a>
					<a class="num" href="<%=request.getContextPath() %>/admin/memberlist?page=${page - 1}">${page - 1 }</a>
				<%} %>
				...
				<%if((Integer)(request.getAttribute("page")) < (Integer)(request.getAttribute("totalPage")) - 1) {%>
					<span class="num">...</span>
					<a class="num" href="<%=request.getContextPath() %>/admin/memberlist?page=${totalPage }">${totalPage }</a>
				<%} %>
				<%if((Integer)(request.getAttribute("page")) != (Integer)(request.getAttribute("totalPage"))) {%>
					<a class="next" href="<%=request.getContextPath() %>/admin/memberlist?page=${page + 1}">&gt;&gt;</a>
				<%} %>
